...
## Generate the plot
  png("C4/ExData_Plotting1/plot2.png", width = 480, height = 480)
  with(hpc_feb2007, plot(Date_Time, Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = ""))
  dev.off()
