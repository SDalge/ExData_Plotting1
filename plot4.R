...
## Generate the plot
  png("C4/ExData_Plotting1/plot4.png", width = 480, height = 480)
  par(mfrow = c(2,2))

  with(hpc_feb2007,{
    plot(Date_Time, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
    plot(Date_Time, Voltage, type = "l")
    plot(Date_Time, Sub_metering_1, ylab = "Energy sub metering", type = "l", xlab = "")
    points(Date_Time, Sub_metering_2, col = "red", type = "l")
    points(Date_Time, Sub_metering_3, col = "blue", type = "l")
    legend("topright", pch = NA, lwd = 2,col = c("black","red","blue"), legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty = "n" )
