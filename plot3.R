...
## Generate the plot
  png("C4/ExData_Plotting1/plot3.png", width = 480, height = 480)
  with(hpc_feb2007, plot(Date_Time, Sub_metering_1, ylab = "Energy sub metering", type = "l", xlab = ""))
  points(hpc_feb2007$Date_Time, hpc_feb2007$Sub_metering_2, col = "red", type = "l")
  points(hpc_feb2007$Date_Time, hpc_feb2007$Sub_metering_3, col = "blue", type = "l")
  legend("topright", pch = NA, lwd = 2,col = c("black","red","blue"), legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3") )
  dev.off()
